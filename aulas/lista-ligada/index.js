class LinkedList {
    ...
    push(element){ // Insere um elemento no final da lista ligada.
        ...
        // Variável auxiliar do tipo Node, para percorrer toda a fila, Node após Node.        let current; 
...
// Testando as classes LinkedList e Node:
...
console.log("lista.head.element: "+lista.head.element); // Argemiro
